...
#         label = QLabel("Filter wheel",  self)
...
#         client.publish("Publishing message to topic", "microscope/light_sheet_microscope/UI/state", json.dumps({"type": "device", "payload":{"name": "filter wheel", "state": "turning off"}}))
#         time.sleep(1)
#         client.loop_stop()
